    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="http://webdev2016-garvinmatt.rhcloud.com/home">Home <span class="sr-only">(current)</span></a></li>
                <li><a href="http://webdev2016-garvinmatt.rhcloud.com/profile">Profile</a></li>
    ...
    <form class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <a class="btn btn-success col-sm-12" href="http://webdev2016-garvinmatt.rhcloud.com/profile">Login</a>
            </div>
        </div>
    </form>
</div>
